...
This guide will help you navigate the key conceptual shifts as you transition into the Simplicity world. (You can also check out [a blog post by Artem Chystiakov](https://medium.com/@Arvolear/evm-vs-simplicity-6b96bd64b987) comparing the two environments and ecosystems.)
