...
The steps below should then be sufficient to perform your first Simplicity <glossary:transaction> with an on-chain <glossary:contract> written in <glossary:SimplicityHL>!
