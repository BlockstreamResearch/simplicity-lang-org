...
pub trait JetInfo {
    ...
    /// Information about the section to which the jet belongs.
    fn section_info(&self) -> String;

    /// Indicates whether the jet is deprecated.
...
The assertion fails.",
            ...
            Elements::Add8 => "Add two integers and return the carry.",
            Elements::Add16 => "Add two integers and return the carry.",
            Elements::Add32 => "Add two integers and return the carry.",
            Elements::Add64 => "Add two integers and return the carry.",
            Elements::Decrement8 => "Decrement an integer by one and return the borrow bit.",
            Elements::Decrement16 => "Decrement an integer by one and return the borrow bit.",
            Elements::Decrement32 => "Decrement an integer by one and return the borrow bit.",
            Elements::Decrement64 => "Decrement an integer by one and return the borrow bit.",
            Elements::DivMod8 => "Divide the first integer by the second integer, and return the remainder.",
            Elements::DivMod16 => "Divide the first integer by the second integer, and return the remainder.",
            Elements::DivMod32 => "Divide the first integer by the second integer, and return the remainder.",
...
Return `(u64::MAX, u64::MAX)` when the preconditions are not satisfied.",
            Elements::Divide8 => "Divide the first integer by the second integer.",
            Elements::Divide16 => "Divide the first integer by the second integer.",
            Elements::Divide32 => "Divide the first integer by the second integer.",
            Elements::Divide64 => "Divide the first integer by the second integer.",
            Elements::Divides8 => "Check if the first integer is divisible by the second integer.",
            Elements::Divides16 => "Check if the first integer is divisible by the second integer.",
            Elements::Divides32 => "Check if the first integer is divisible by the second integer.",
            Elements::Divides64 => "Check if the first integer is divisible by the second integer.",
            Elements::FullAdd8 => "Add two integers. Take a carry-in and return a carry-out.",
            Elements::FullAdd16 => "Add two integers. Take a carry-in and return a carry-out.",
            Elements::FullAdd32 => "Add two integers. Take a carry-in and return a carry-out.",
            Elements::FullAdd64 => "Add two integers. Take a carry-in and return a carry-out.",
            Elements::FullDecrement8 => "Decrement an integer by one. Take a borrow-in and return a borrow-out.",
            Elements::FullDecrement16 => "Decrement an integer by one. Take a borrow-in and return a borrow-out.",
            Elements::FullDecrement32 => "Decrement an integer by one. Take a borrow-in and return a borrow-out.",
            Elements::FullDecrement64 => "Decrement an integer by one. Take a borrow-in and return a borrow-out.",
            Elements::FullIncrement8 => "Increment an integer by one. Take a carry-in and return a carry-out.",
            Elements::FullIncrement16 => "Increment an integer by one. Take a carry-in and return a carry-out.",
            Elements::FullIncrement32 => "Increment an integer by one. Take a carry-in and return a carry-out.",
            Elements::FullIncrement64 => "Increment an integer by one. Take a carry-in and return a carry-out.",
            Elements::FullMultiply8 => "Helper for multiplying integers. Take the product of the first pair of integers and add the sum of the second pair.",
            Elements::FullMultiply16 => "Helper for multiplying integers. Take the product of the first pair of integers and add the sum of the second pair.",
            Elements::FullMultiply32 => "Helper for multiplying integers. Take the product of the first pair of integers and add the sum of the second pair.",
            ...
            Elements::FullSubtract8 => "Subtract the second integer from the first integer. Take a borrow-in and return a borrow-out.",
            Elements::FullSubtract16 => "Subtract the second integer from the first integer. Take a borrow-in and return a borrow-out.",
            Elements::FullSubtract32 => "Subtract the second integer from the first integer. Take a borrow-in and return a borrow-out.",
            Elements::FullSubtract64 => "Subtract the second integer from the first integer. Take a borrow-in and return a borrow-out.",
            Elements::Increment8 => "Increment an integer by one and return the carry.",
            Elements::Increment16 => "Increment an integer by one and return the carry.",
            Elements::Increment32 => "Increment an integer by one and return the carry.",
            Elements::Increment64 => "Increment an integer by one and return the carry.",
            Elements::IsOne8 => "Check if an integer is one.",
            Elements::IsOne16 => "Check if an integer is one.",
            Elements::IsOne32 => "Check if an integer is one.",
            Elements::IsOne64 => "Check if an integer is one.",
            Elements::IsZero8 => "Check if an integer is zero.",
            Elements::IsZero16 => "Check if an integer is zero.",
            Elements::IsZero32 => "Check if an integer is zero.",
            Elements::IsZero64 => "Check if an integer is zero.",
            Elements::Le8 => "Check if an integer is less than or equal to another integer.",
            Elements::Le16 => "Check if an integer is less than or equal to another integer.",
            Elements::Le32 => "Check if an integer is less than or equal to another integer.",
            Elements::Le64 => "Check if an integer is less than or equal to another integer.",
            Elements::Lt8 => "Check if an integer is less than another integer.",
            Elements::Lt16 => "Check if an integer is less than another integer.",
            Elements::Lt32 => "Check if an integer is less than another integer.",
            Elements::Lt64 => "Check if an integer is less than another integer.",
            Elements::Max8 => "Return the bigger of two integers.",
            Elements::Max16 => "Return the bigger of two integers.",
            Elements::Max32 => "Return the bigger of two integers.",
            Elements::Max64 => "Return the bigger of two integers.",
            Elements::Median8 => "Return the median of three integers.",
            Elements::Median16 => "Return the median of three integers.",
            Elements::Median32 => "Return the median of three integers.",
            Elements::Median64 => "Return the median of three integers.",
            Elements::Min8 => "Return the smaller of two integers.",
            Elements::Min16 => "Return the smaller of two integers.",
            Elements::Min32 => "Return the smaller of two integers.",
            Elements::Min64 => "Return the smaller of two integers.",
            Elements::Modulo8 => "Compute the remainder after dividing both integers.",
            Elements::Modulo16 => "Compute the remainder after dividing both integers.",
            Elements::Modulo32 => "Compute the remainder after dividing both integers.",
            ...
            Elements::Subtract8 => "Subtract the second integer from the first integer, and return the borrow bit.",
            Elements::Subtract16 => "Subtract the second integer from the first integer, and return the borrow bit.",
            Elements::Subtract32 => "Subtract the second integer from the first integer, and return the borrow bit.",
...
- Return `Some(ge)` even if the x-coordinate is not normalized.",
            ...
            Elements::GeIsOnCurve => "Check if the given point satisfies the curve equation y² = x³ + 7.",
            Elements::GejIsOnCurve => "Check if the given point satisfies the curve equation y² = x³ + 7.",
            Elements::GeNegate => "Negate a point.",
...
"Assert that a Schnorr signature matches a public key and message, using a custom sighash mode.
...
This jet should not be used directly.",
            ...
            Elements::TapdataInit => "Create a SHA256 context, initialized with a `TapData` tag.",
            Elements::AnnexHash =>
...
Note: this matches Elements's modified BIP-0341 definition of tapleaf hash.",
...
Using the notation of BIP-0341, it returns the SHA256 hash of c33: 33 + 32m.",
            Elements::TxHash =>
"Return the SHA256 hash of the following:
...
"**Deprecated; do not use.** Assert that the value returned by `tx_lock_duration` is greater than or equal to the given value.
...
Return zero for any asset without fees.",
    ...
    fn section_info(&self) -> String {
        match self {
            ...
            | Elements::XorXor16
            | Elements::XorXor32
            | Elements::XorXor64 => "Multi-bit logic",
            Elements::Add8
            | Elements::Add16
            | Elements::Add32
            | Elements::Add64
            ...
            | Elements::Subtract16
            | Elements::Subtract32
            | Elements::Subtract64 => "Arithmetic",
            ...
            | Elements::Sha256Iv => "Hash functions",
            Elements::Decompress
            | Elements::FeAdd
            | Elements::FeInvert
            | Elements::FeIsOdd
            ...
            | Elements::Scale
            | Elements::HashToCurve
            | Elements::Swu => "Elliptic curve functions",
            Elements::Bip0340Verify | Elements::CheckSigVerify => "Digital Signatures",
            ...
            | Elements::TapleafHash
            | Elements::TappathHash
            | Elements::TxHash => "Signature hash modes",
            Elements::CheckLockDistance
            | Elements::CheckLockDuration
            | Elements::CheckLockHeight
            | Elements::CheckLockTime
            ...
            | Elements::TxLockTime => "Time locks",
...
/// All [`Elements`] jets, sorted as in documentation.
pub const ALL_JETS_SORTED: [Elements; 471] = [
    Elements::All8,
    Elements::All16,
    Elements::All32,
    Elements::All64,
